...
public class ViewActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        String[] strs = getResources().getStringArray(R.array.array_list1);





        adapter.addFragment(new TextViewFragment(), strs[0]);
        adapter.addFragment(new LinearLayoutFragment(), strs[1]);
